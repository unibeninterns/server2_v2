...
class SubmitController {
  ...
  submitStaffProposal = asyncHandler(async (req: Request<{}, {}, IStaffProposalRequest>, res: Response<IProposalResponse>): Promise<void> => {
    const {
      fullName,
      academicTitle,
      department,
    ...
    if (coInvestigators) {
      try {
        ...
        logger.error('Failed to parse coInvestigators:', error instanceof Error ? error.message : 'Unknown error');
    ...
    try {
      ...
      logger.error('Failed to send emails:', error instanceof Error ? error.message : 'Unknown error');
  ...
  submitMasterStudentProposal = asyncHandler(async (req: Request<{}, {}, IMasterStudentProposalRequest>, res: Response<IProposalResponse>): Promise<void> => {
  ...
  getUserProposalsByEmail = asyncHandler(async (req: Request<{ email: string }>, res: Response<IProposalResponse>): Promise<void> => {
  ...
  // Get proposal by ID
  getProposalById = asyncHandler(async (req: Request<{ id: string }>, res: Response<IProposalResponse>): Promise<void> => {
    const { id } = req.params;
